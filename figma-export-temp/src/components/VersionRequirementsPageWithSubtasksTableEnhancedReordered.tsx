...
const mockVersionRequirements: VersionRequirement[] = [
  ...
  },
  {
    ...
    subtasks: generateDefaultSubtasks('2').map(subtask => ({
      ...subtask,
      // 为第二个需求的子任务添加一些示例数据
      estimatedStartDate: subtask.name === '前端开发' ? '2024-04-15T09:00:00.000Z' : undefined,
      estimatedEndDate: subtask.name === '前端开发' ? '2024-04-25T18:00:00.000Z' : undefined,
      actualStartDate: subtask.name === '前端开发' ? '2024-04-16T09:30:00.000Z' : undefined,
      actualEndDate: subtask.name === '前端开发' ? '2024-04-28T17:30:00.000Z' : undefined,
                                ...
                                <TableCell colSpan={10} className="p-0 bg-muted/20">
                                  <div className="p-4">
                                    ...
                                    <Table>
                                      <TableHeader>
                                        <TableRow>
                                          <TableHead className="text-xs w-48">任务名称</TableHead>
                                          <TableHead className="text-xs w-28">执行人</TableHead>
                                          <TableHead className="text-xs w-24">部门</TableHead>
                                          <TableHead className="text-xs w-20">状态</TableHead>
                                          <TableHead className="text-xs w-36">预计开始</TableHead>
                                          <TableHead className="text-xs w-36">预计结束</TableHead>
                                          <TableHead className="text-xs w-20">预估耗时(h)</TableHead>
                                          <TableHead className="text-xs w-36">实际开始</TableHead>
                                          <TableHead className="text-xs w-36">实际结束</TableHead>
                                          <TableHead className="text-xs w-20">实际耗时(h)</TableHead>
                                          <TableHead className="text-xs w-20">延期状态</TableHead>
                                        </TableRow>
                                      </TableHeader>
                                      <TableBody>
                                        {requirement.subtasks.map((subtask) => (
                                          ...
                                          >
                                            {/* 任务名称 - 可编辑 */}
                                            <TableCell 
                                              className="py-2 cursor-pointer w-48"
                                            ...
                                            <TableCell className="py-2 w-28">
                                              {subtask.executor ? (
                                                <DropdownMenu>
                                                  <DropdownMenuTrigger asChild>
                                                    <div className="flex items-center gap-2 cursor-pointer hover:bg-accent px-2 py-1 rounded w-full">
                                                      <Avatar className="h-5 w-5 flex-shrink-0">
                                                        <AvatarFallback className="text-xs">{subtask.executor.name[0]}</AvatarFallback>
                                                      </Avatar>
                                                      <span className="text-xs truncate">{subtask.executor.name}</span>
                                                    </div>
                                                  </DropdownMenuTrigger>
                                                  <DropdownMenuContent>
                                                ...
                                                <DropdownMenu>
                                                  <DropdownMenuTrigger asChild>
                                                    <span className="text-xs text-muted-foreground cursor-pointer hover:bg-accent px-2 py-1 rounded w-full block text-center">未分配</span>
                                                  </DropdownMenuTrigger>
                                                  <DropdownMenuContent>
                                                    {mockUsers.map((user) => (
                                                      <DropdownMenuItem 
                                            ...
                                            <TableCell className="py-2 w-24">
                                              {subtask.department ? (
                                                <DropdownMenu>
                                                  <DropdownMenuTrigger asChild>
                                                    <Badge variant="outline" className="text-xs cursor-pointer hover:bg-accent w-full justify-center truncate">
                                            ...
                                            {/* 预计开始 - 可编辑 */}
                                            <TableCell 
                                              className="py-2 cursor-pointer w-36"
                                            ...
                                            >
                                              {editingCell?.requirementId === requirement.id && 
                                               ...
                                               editingCell?.field === 'estimatedStartDate' ? (
                                                ...
                                                <span className="text-xs text-muted-foreground hover:bg-accent px-2 py-1 rounded w-full block">
