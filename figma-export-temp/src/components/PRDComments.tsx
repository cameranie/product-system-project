...
const mockComments: Comment[] = [
  {
    id: '1',
    content: 'PRD中的用户流程图部分建议增加异常情况的处理逻辑，比如支付失败、网络超时等场景。',
    author: mockUsers[1],
  ...
  {
    id: '2',
    content: '技术实现方案中提到的API接口设计需要和后端团队确认一下，特别是数据结构部分。',
    author: mockUsers[2],
  ...
  {
    id: '3',
    content: 'UI设计稿已经完成，可以开始前端开发了。预计2周内完成。',
    author: mockUsers[3],
...
export function PRDComments({ prdId, currentUser }: PRDCommentsProps) {
