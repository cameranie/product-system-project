...
const mockRequirements: Requirement[] = [
  ...
  },
  {
    ...
    description: '���加多语言支持功能，支持中文、英文等多种语言切换，扩大用户群体。',
    tags: ['国际化', '多语言', 'i18n'],
                  ...
                  <TableRow key={requirement.id} className="hover:bg-muted/50">
                      ...
                      {requirement.reviewer1 ? (
                        <div className="flex items-center gap-2">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start">
                              <DropdownMenuItem onClick={() => handleReviewer1StatusChange(requirement.id, 'pending')}>
                                待审核
                              </DropdownMenuItem>
                              <DropdownMenuItem onClick={() => handleReviewer1StatusChange(requirement.id, 'approved')}>
                                通过
                              </DropdownMenuItem>
                              <DropdownMenuItem onClick={() => handleReviewer1StatusChange(requirement.id, 'rejected')}>
                                不通过
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                      ...
                      {requirement.reviewer2 ? (
                        <div className="flex items-center gap-2">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start">
                              <DropdownMenuItem onClick={() => handleReviewer2StatusChange(requirement.id, 'pending')}>
                                待审核
                              </DropdownMenuItem>
                              <DropdownMenuItem onClick={() => handleReviewer2StatusChange(requirement.id, 'approved')}>
                                通过
                              </DropdownMenuItem>
                              <DropdownMenuItem onClick={() => handleReviewer2StatusChange(requirement.id, 'rejected')}>
                                不通过
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Badge 
                            variant={requirement.plannedVersion ? 'default' : 'secondary'}
                            className="cursor-pointer hover:bg-muted text-xs"
                          >
                        ...
                        <DropdownMenuContent align="start">
                          <DropdownMenuItem onClick={() => handleVersionSelect(requirement.id, '')}>
                            未分配版本
                          </DropdownMenuItem>
