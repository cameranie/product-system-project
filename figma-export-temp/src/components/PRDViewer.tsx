...
export function PRDViewer({ prd, onBack, onEdit, onNavigate }: PRDViewerProps) {
  ...
  const handleRequirementClick = (requirement: RequirementRef) => {
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  <div 
                    ...
                    style={{ backgroundColor: prd.project?.color || '#3b82f6' }}
                  />
                  <span className="text-sm">{prd.project?.name || '未指定'}</span>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {(!prd.linkedRequirements || prd.linkedRequirements.length === 0) && (
            ...
            <CardContent>
              {(!prd.linkedRequirements || prd.linkedRequirements.length === 0) ? (
                ...
                <div className="space-y-3">
                  {prd.linkedRequirements?.map((requirement) => (
                    <div 
                      key={requirement.id} 
