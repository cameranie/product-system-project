...
const secondLevelReviewers: User[] = [
  ...
  { id: '4', name: '卢兆���', avatar: '/avatars/luzhaofeng.jpg', email: 'luzhaofeng@example.com' },
...
// 张三用户
const zhangSan: User = { id: 'zs1', name: '张三', avatar: '/avatars/zhangsan.jpg', email: 'zhangsan@example.com' };
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  >
                    {requirement.reviewStatus === 'approved' ? '评审通过' : 
                     ...
                     requirement.reviewStatus === 'fourth_review' ? '四级评审中' :
                     requirement.reviewStatus === 'third_review' ? '三级评审中' :
                ...
                <div className="p-3 border rounded-lg hover:bg-muted/30 transition-colors">
                  ...
                  <div className="space-y-2 mt-1">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer1Status === 'approved'}
                            onCheckedChange={(checked) => {
                              if (checked) {
                                handleReviewer1StatusChange('approved');
                              } else {
                                handleReviewer1StatusChange('pending');
                              }
                            }}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer1Status === 'rejected'}
                            onCheckedChange={(checked) => {
                              if (checked) {
                                handleReviewer1StatusChange('rejected');
                              } else {
                                handleReviewer1StatusChange('pending');
                              }
                            }}
                      ...
                      {requirement.reviewer1Status === 'pending' && (
                ...
                <div className="p-3 border rounded-lg hover:bg-muted/30 transition-colors">
                  ...
                  <div className="space-y-2 mt-1">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer2Status === 'approved'}
                            disabled={requirement.reviewer1Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              if (checked) {
                                handleReviewer2StatusChange('approved');
                              } else {
                                handleReviewer2StatusChange('pending');
                              }
                            }}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer2Status === 'rejected'}
                            disabled={requirement.reviewer1Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              if (checked) {
                                handleReviewer2StatusChange('rejected');
                              } else {
                                handleReviewer2StatusChange('pending');
                              }
                            }}
                      ...
                      {requirement.reviewer2Status === 'pending' && (
                        <div className="flex items-center gap-1 text-xs text-orange-500">
                          <Clock className="h-3 w-3" />
                          待评审
                        </div>
              ...
              {/* 三级评审 - 统一框架样式 */}
              {requirement.reviewer3 && (
                <div className="p-3 border rounded-lg hover:bg-muted/30 transition-colors">
                  <Label className="text-xs text-muted-foreground">三级评审人</Label>
                  <div className="space-y-2 mt-1">
                    <div className="flex items-center gap-2">
                      <Avatar className="h-6 w-6">
                        <AvatarImage src={requirement.reviewer3.avatar} />
                        <AvatarFallback>{requirement.reviewer3.name[0]}</AvatarFallback>
                      </Avatar>
                      <span className="text-sm">{requirement.reviewer3.name}</span>
                      <div className="flex items-center gap-1 ml-auto">
                        {requirement.reviewer3Status === 'approved' ? (
                          <CheckCircle className="h-3 w-3 text-green-500" />
                        ) : requirement.reviewer3Status === 'rejected' ? (
                          <XCircle className="h-3 w-3 text-red-500" />
                        ) : (
                          <Clock className="h-3 w-3 text-orange-500" />
                        )}
                        <span className="text-xs text-muted-foreground">
                          {requirement.reviewer3Status === 'approved' ? '已通过' : 
                           requirement.reviewer3Status === 'rejected' ? '不通过' : 
                           '待评审'}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer3Status === 'approved'}
                            disabled={requirement.reviewer2Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              setRequirement(prev => ({
                                ...prev,
                                reviewer3Status: checked ? 'approved' : 'pending'
                              }));
                            }}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer3Status === 'rejected'}
                            disabled={requirement.reviewer2Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              setRequirement(prev => ({
                                ...prev,
                                reviewer3Status: checked ? 'rejected' : 'pending'
                              }));
                            }}
                          />
                      ...
                      {requirement.reviewer3Status === 'pending' && (
                        <div className="flex items-center gap-1 text-xs text-orange-500">
                          <Clock className="h-3 w-3" />
                          待评审
                        </div>
              ...
              {/* 四级评审 - 统一框架样式 */}
              {requirement.reviewer4 && (
                <div className="p-3 border rounded-lg hover:bg-muted/30 transition-colors">
                  <Label className="text-xs text-muted-foreground">四级评审人</Label>
                  <div className="space-y-2 mt-1">
                    <div className="flex items-center gap-2">
                      <Avatar className="h-6 w-6">
                        <AvatarImage src={requirement.reviewer4.avatar} />
                        <AvatarFallback>{requirement.reviewer4.name[0]}</AvatarFallback>
                      </Avatar>
                      <span className="text-sm">{requirement.reviewer4.name}</span>
                      <div className="flex items-center gap-1 ml-auto">
                        {requirement.reviewer4Status === 'approved' ? (
                          <CheckCircle className="h-3 w-3 text-green-500" />
                        ) : requirement.reviewer4Status === 'rejected' ? (
                          <XCircle className="h-3 w-3 text-red-500" />
                        ) : (
                          <Clock className="h-3 w-3 text-orange-500" />
                        )}
                        <span className="text-xs text-muted-foreground">
                          {requirement.reviewer4Status === 'approved' ? '已通过' : 
                           requirement.reviewer4Status === 'rejected' ? '不通过' : 
                           '待评审'}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer4Status === 'approved'}
                            disabled={requirement.reviewer3Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              setRequirement(prev => ({
                                ...prev,
                                reviewer4Status: checked ? 'approved' : 'pending'
                              }));
                            }}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={requirement.reviewer4Status === 'rejected'}
                            disabled={requirement.reviewer3Status !== 'approved'}
                            onCheckedChange={(checked) => {
                              setRequirement(prev => ({
                                ...prev,
                                reviewer4Status: checked ? 'rejected' : 'pending'
                              }));
                            }}
                          />
                      ...
                      {requirement.reviewer4Status === 'pending' && (
                        <div className="flex items-center gap-1 text-xs text-orange-500">
                          <Clock className="h-3 w-3" />
                          待评审
                        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <Button
                variant="outline"
                className="w-full justify-start"
                onClick={handleNavigateToCreateBug}
              >
