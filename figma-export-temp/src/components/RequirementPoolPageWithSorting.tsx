                ...
                <div className="flex items-center gap-2">
                    ...
                    <DropdownMenuContent className="w-80 p-4" align="start">
                      <div className="space-y-4">
                        <div className="text-sm font-medium">筛选设置</div>
                          ...
                          <div className="text-sm font-medium mb-2">筛选条件</div>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-72 p-4" align="start">
                      <div className="space-y-4">
                        <div className="text-sm font-medium">排序设置</div>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <Select
                              ...
                              onValueChange={(value) => {
                                if (value) {
                                  handleSort(value, sortConfig?.direction || 'asc');
                                } else {
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="">无排序</SelectItem>
                                {filterableColumns.map((col) => (
                                  <SelectItem key={col.value} value={col.value}>
                                    {col.label}
                                  </SelectItem>
                            ...
                            {sortConfig && (
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                  <DropdownMenuItem 
                                    onClick={() => handleSort(sortConfig.column, 'asc')}
                                  >
                                    <ArrowUp className="h-3 w-3 mr-2" />
                                    升序
                                  </DropdownMenuItem>
                                  <DropdownMenuItem 
                                    onClick={() => handleSort(sortConfig.column, 'desc')}
                                  >
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">已选择 {selectedRequirements.length} 项</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    批量通过一级评审 ({getFirstLevelEligibleCount()})
                  </Button>
                  ...
                  >
                    ...
                    批量通过二级评审 ({getSecondLevelEligibleCount()})
                  </Button>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuItem onClick={() => handleBatchSetVersion('')}>
                        清除版本号
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                  ...
                  <TableHeader className="sticky top-0 bg-background z-10">
                    <TableRow>
                      <TableHead className="w-12">
                        <Checkbox
                          checked={selectedRequirements.length === sortedRequirements.length}
                      ...
                      {!hiddenColumns.includes('scheduledVersion') && <TableHead>版本号</TableHead>}
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                              ...
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  <Badge variant="outline" className="cursor-pointer hover:bg-accent text-xs">
                                    {getVersionDisplay(requirement) || '设置版本'}
                                  </Badge>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent>
                                  {versionOptions.map((version) => (
                                  ...
                                  <DropdownMenuSeparator />
                                  <DropdownMenuItem 
                                    onClick={() => handleVersionChange(requirement.id, '')}
                                  >
                                    清除版本号
                                  </DropdownMenuItem>
                                </DropdownMenuContent>
